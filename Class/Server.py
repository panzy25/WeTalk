...
from .info_model import Social_Network_Model
from .Basic_info import State, number_infected
...
model_params = {
    ...
    "info_check_frequency": UserSettableParameter(
        "slider",
...
server = ModularServer(
    Social_Network_Model, [network, MyTextElement(), chart], "Virus Model", model_params
)
server.port = 8521
